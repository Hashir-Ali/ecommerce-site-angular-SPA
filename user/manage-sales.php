                            ...
                            <div class="card-body">
                                        ...
                                        <div class="table-responsive m-t-40">
                                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>#92 by Tiger Nixon <br><br><a href="mailto:tiger@nixon.com">tiger@nixon.com</a></td>
                                                        <td>Perish villa, 1221  Henery Street, ANCHORAGE, Alaska, 99501</td>
                                                        <td><span class="label label-warning">Departed</span></td>
                                                        <td>2011/04/25</td>
                                                        <td>$320</td>
                                                        <td>
                                                   ...
                                                   <tr>
                                                        <td>#92 by Tiger Nixon <br><br><a href="mailto:tiger@nixon.com">tiger@nixon.com</a></td>
                                                        <td>Perish villa, 1221  Henery Street, ANCHORAGE, Alaska, 99501</td>
                                                        <td><span class="label label-success">Reached</span></td>
                                                        <td>2011/04/25</td>
                                                        <td>$320</td>
                                                        <td>
                                                            <button class="btn btn-info">
